...
Deploy as a separate Railway service (same project as aegis-backend).
Backend calls it via Railway private networking: http://aegis-tts.railway.internal:8000
"""
...
app = FastAPI(title="AEGIS TTS Sidecar", lifespan=lifespan)
